...
pwd=os.getcwd()
logo=f'''
{green}   ____    _____    ____    ____    ____ 
{yellow}  / __ \  / ___/   / __ \  / __ \  / __ \ 
{red} / / / / \__ \    / /_/ / / /_/ / / / / /
{blue}/ /_/ / ___/ /   / ____/ / _, _/ / /_/ / 
{cyan}\____/  /____/  /_/      /_/ |_| \____/  
{purple}                             [By OnixSat]
                                         
'''
def sprint(sentence, second=0.002):
...
def about():
    ...
    print(f"{cyan}[Github]    {purple} :[https://github.com/onixsat]")
    print(f"{cyan}[Messenger] {purple} :[https://m.me/OnixSat]")
    print(f"{cyan}[Email]     {purple} :[onixsat6@gmail.com]\n")
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Encrypted by OSPro\n# Github- https://ospro.pt\n\n"+filedata)
    os.remove(".temp")
...
def decryptsh():
    ...
    with open(".temp2",'r') as temp_f2, open(out_file,'w') as out_f:
        ...
        out_f.write("# Decrypted by OSPro-Ofuscator\n# Github- https://github.com/onixasat\n\n"+filedata)
    os.remove(".temp2")
    sprint(f"{success}{out_file} saved in {pwd}")
    mover(out_file)
...
def encryptvar():
    ...
    with open(in_file, 'r', encoding='utf-8', errors='ignore') as in_f,open(out_file, 'w') as out_f:
       ...
       out_f.write("# Encrypted by OSPro-Ofuscator\n# Github- https://github.com/onixsat\n\n"+obfuscated_content)
    sprint(f"{success}{out_file} saved in {pwd}")
    mover(out_file)
